...
export default function HomeScreen() {
  ...
  useEffect(() => {
    console.log("[HomeScreen iOS Web] Mounted, user:", user);
    if (!authLoading && !user) {
      console.log("[HomeScreen iOS Web] User not authenticated, redirecting to auth");
      router.replace("/auth");
    }
  }, [user, authLoading]);
  ...
  const handleAskButtonPress = async () => {
    console.log("[HomeScreen iOS Web] Ask button pressed - sharing link");
  ...
  const handleShareLink = async () => {
    console.log("[HomeScreen iOS Web] Share link option selected");
    setSending(true);
    ...
    try {
      ...
      console.log("[HomeScreen iOS Web] Message created with link:", response);
      ...
      console.log("[HomeScreen iOS Web] Link generated successfully");
    } catch (error: any) {
      console.error("[HomeScreen iOS Web] Error sharing link:", error);
      showConfirmMessage(
        "Error",
